...
import { EventVideoPlayer } from "@/components/event-video-player"
...
export default function EventRoom() {
  ...
  const [tipAmount, setTipAmount] = useState(0.03)
  ...
  const [chatMessages, setChatMessages] = useState([
    ...
    { id: 3, user: "art_lover.eth", message: "The colors are amazing already", timestamp: new Date().toISOString() },
    {
      id: 4,
      user: "nft_whale.eth",
      message: "Just tipped 0.13 SOL! Love your work",
      timestamp: new Date().toISOString(),
    },
  ])
  ...
  const participants = [
    ...
    { id: 3, name: "art_lover.eth", avatar: "/placeholder.svg?height=40&width=40", tipped: 0.23 },
    { id: 4, name: "nft_whale.eth", avatar: "/placeholder.svg?height=40&width=40", tipped: 0.13 },
    { id: 5, name: "crypto_fan.eth", avatar: "/placeholder.svg?height=40&width=40", tipped: 0.1 },
    { id: 6, name: "web3_user.eth", avatar: "/placeholder.svg?height=40&width=40", tipped: 0.07 },
    { id: 7, name: "defi_guy.eth", avatar: "/placeholder.svg?height=40&width=40", tipped: 0.03 },
  ...
  const handleTipSuccess = () => {
    ...
    setChatMessages([
      ...chatMessages,
      {
        id: chatMessages.length + 1,
        user: "system",
        message: `${userProfile?.ensName || "you.eth"} tipped ${tipAmount} SOL!`,
        timestamp: new Date().toISOString(),
      },
    ])
                  ...
                  {viewMode === "watch" ? (
                    <>
                      ...
                      <div className="flex items-center space-x-4 mb-4">
                        ...
                        />
                        <span className="font-medium">{tipAmount} SOL</span>
                      </div>
                      <div className="flex space-x-2">
                        {[0.03, 0.07, 0.13, 0.33].map((amount) => (
                          ...
                          {participants.map((participant) => (
                            <div key={participant.id} className="flex items-center justify-between">
                              ...
                              {participant.tipped && (
                                <div className="flex items-center text-primary">
                                  <DollarSign className="h-4 w-4 mr-1" />
                                  <span>{participant.tipped} SOL</span>
                                </div>
                              )}
                            </div>
                          ))}
