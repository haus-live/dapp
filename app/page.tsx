...
import { Web3InnovationGraphic } from "@/components/web3-innovation-graphic"
...
const RtaInfoModal = lazy(() => import("@/components/rta-info-modal").then((mod) => ({ default: mod.RtaInfoModal })))
const QuickAccess = lazy(() => import("@/components/quick-access").then((mod) => ({ default: mod.QuickAccess })))
