      ...
      <CardContent>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            <Button onClick={() => handlePresetTip(0.1)} disabled={isProcessing || !wallet.connected} variant="outline">
              0.1 SOL
            </Button>
            <Button onClick={() => handlePresetTip(0.5)} disabled={isProcessing || !wallet.connected} variant="outline">
              0.5 SOL
            </Button>
            <Button onClick={() => handlePresetTip(1)} disabled={isProcessing || !wallet.connected} variant="outline">
              1 SOL
            </Button>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex">
              ...
              <Button
                ...
                disabled={isProcessing || !wallet.connected || !customAmount}
                className="ml-2"
              >
                Tip
              </Button>
          ...
          {!wallet.connected && <p className="text-sm text-red-500">Please connect your wallet to tip the artist.</p>}
        </div>
      </CardContent>
    </Card>
  )
